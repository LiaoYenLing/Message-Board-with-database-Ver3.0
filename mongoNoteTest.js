...
co(function* () {
    ...
    var docs = [
	 { title:"title1", body:"body1", date:"date1", time:"time1"}, 
    ...
    var objs = yield notes.update({title:"title2"}, {title:"title2 new", body:"body 2 new", date:"date2 new", time:"time2 new"}); // 修改記事
